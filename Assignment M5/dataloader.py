...
class EnglishSpanishDataset(Dataset):
    def __init__(self, words_df: pd.DataFrame, sentences_df: pd.DataFrame, transform=None, target_transform=None):
    ...
    def __getitem__(self, idx: int):
        ...
        input_tensor, target_tensor = self.create_input_and_target_tensor(sentence)
